...
/// The APK fixtures live in an external `ScamShield_Test_APKs/` directory
/// (generated on the original author's machine and not part of this repo).
/// When the fixtures are absent, these tests are skipped instead of failing.
final _skip = !Directory('ScamShield_Test_APKs').existsSync()
    ? 'ScamShield_Test_APKs fixtures not present'
    : false;
