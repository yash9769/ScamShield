...
async def run_tests():
    ...
    with patch("httpx.AsyncClient.get") as mock_get:
        ...
        print("✓ test_check_email_exposure_no_breaches passed")
    ...
    with patch("httpx.AsyncClient.get") as mock_get:
        ...
        print("✓ test_check_email_exposure_with_breaches passed")
    ...
    try:
        ...
        print("✓ test_check_email_exposure_invalid_email passed")
    ...
    with patch("httpx.AsyncClient.get") as mock_get:
        ...
        try:
            ...
            print("✓ test_check_email_exposure_timeout passed")
    ...
    with patch("httpx.AsyncClient.get") as mock_get:
        ...
        try:
            ...
            print("✓ test_check_email_exposure_429 passed")
    ...
    with patch("httpx.AsyncClient.get") as mock_get:
        ...
        try:
            ...
            print("✓ test_check_email_exposure_500 passed")
    ...
    with patch("httpx.AsyncClient.get") as mock_get:
        ...
        try:
            ...
            assert exc.status_code == 502
            print("✓ test_check_email_exposure_malformed_json passed")
